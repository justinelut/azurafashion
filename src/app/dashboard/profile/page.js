...
export default function page() {
  return (
      <main className="profile-page">
          <section className="relative py-16 block h-500-px">
          ...
          <section className="relative mt-38 py-44 bg-blueGray-200">
                          ...
                          <div className="flex flex-wrap justify-center">
                              ...
                              <div className="w-full lg:w-4/12 px-4 lg:order-3 lg:text-right lg:self-center">
                                  <div className="py-6 px-3 mt-32 sm:mt-0">
                                      <button className="bg-gray-500 active:bg-gray-600 uppercase text-white font-bold hover:shadow-md shadow text-xs px-4 py-2 outline-none focus:outline-none sm:mr-2 mb-1 ease-linear transition-all duration-150" type="button">
                                          Connect
                                      </button>
                                  </div>
                              </div>
